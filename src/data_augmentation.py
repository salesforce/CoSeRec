...
class CombinatorialEnumerate(object):
    ...
    def __init__(
        ...
        self.data_augmentation_methods = [
            ...
            Mask(gamma=gamma),
            Reorder(beta=gamma),
            Insert(item_similarity_model, insert_rate=insert_rate, max_insert_num_per_pos=max_insert_num_per_pos),
    ...
    def __call__(self, sequence):
        ...
        for index in substitute_idx:
            if self.ensemble:
                ...
                copied_sequence[index] = copied_sequence[index] = self.item_similarity_model.most_similar(
                    copied_sequence[index]
                )[0]
